...
class iTooltip {
  constructor(selector = "*") {
    const qs = selector !== "*" ? selector : "*[data-title]";
  ...
  init(options = {}) {
    ...
    if (
      this.settings.positionX === "center" &&
      this.settings.positionY === "center"
    ) {
  ...
  createTooltip(event) {
    ...
    this.tooltip.innerHTML = elem.getAttribute("data-title");
  ...
  removeTooltip(event) {
    event.target.setAttribute("data-title", this.tooltip.innerHTML);
    this.tooltip.remove();
  }
